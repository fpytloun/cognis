...
deliverables and step-profile work in Stage 30.
...
- runtime-abstraction changes from specs 17-19 (deferred Stages 27-29)
- typed deliverables and step profiles (Stage 30)
