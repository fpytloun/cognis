...
deliverables and step-profile work in Stage 31.
...
- runtime-abstraction changes from specs 17-19 (deferred Stage 28)
- typed deliverables and step profiles (Stage 31)
