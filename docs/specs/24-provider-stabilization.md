...
and step profiles) lands in [`24-workflow-deliverables implementation`](implementation/stage-24-workflow-deliverables.md).
...
- deeper runtime-abstraction changes from specs 17-19
- UI redesign beyond surfacing the session `/thinking` override in
  `/info` and session state
- typed deliverables and step profiles (deferred to Stage 24)
...
- Typed deliverables and step profiles (see
  ...
  [`stage-24-workflow-deliverables.md`](implementation/stage-24-workflow-deliverables.md)).
