...
| `implementation/stage-39-deterministic-workflows.md` | Planned implementation slice for deterministic workflow steps, including rendering, model validation, tool execution extraction, branching, silent completion, API/UI/tool schema updates, and skill guidance |
