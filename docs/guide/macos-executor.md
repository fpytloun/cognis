...
python3 packaging/homebrew/build_executor_asset.py \
  --architecture arm64 --output "$PWD/cognis-executor-0.14.0-macos-arm64.tar.gz"
python3 packaging/homebrew/build_executor_asset.py \
  --architecture x86_64 --output "$PWD/cognis-executor-0.14.0-macos-x86_64.tar.gz"
arm_sha="$(shasum -a 256 cognis-executor-0.14.0-macos-arm64.tar.gz | awk '{print $1}')"
intel_sha="$(shasum -a 256 cognis-executor-0.14.0-macos-x86_64.tar.gz | awk '{print $1}')"
python3 packaging/homebrew/generate_formula.py --development \
  --version 0.14.0 \
  --arm64-url "file://$PWD/cognis-executor-0.14.0-macos-arm64.tar.gz" \
  --arm64-sha256 "$arm_sha" \
  --x86-64-url "file://$PWD/cognis-executor-0.14.0-macos-x86_64.tar.gz" \
...
python3 packaging/homebrew/generate_formula.py --development \
  ...
  --version 0.14.0 \
  --arm64-asset "$PWD/cognis-executor-0.14.0-macos-arm64.tar.gz" \
  --arm64-sha256 "$arm_sha" \
  --x86-64-asset "$PWD/cognis-executor-0.14.0-macos-x86_64.tar.gz" \
  --x86-64-sha256 "$intel_sha" \
  --output CognisExecutor.rb
