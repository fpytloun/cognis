<script lang="ts">
  ...
  // Clean-URL deep link for /settings/providers. Redirects to the canonical
  // /settings?tab=providers. Three-layer redirect strategy:
  ...
  onMount(() => {
    void goto('/settings?tab=providers', { replaceState: true });
  });
</script>

<svelte:head>
  <title>Settings · providers · Cognis</title>
  <meta http-equiv="refresh" content="0; url=/settings?tab=providers" />
</svelte:head>
