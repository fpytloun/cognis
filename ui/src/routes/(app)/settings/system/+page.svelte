<script lang="ts">
  ...
  // Clean-URL deep link for /settings/system. Redirects to the canonical
  // /settings?tab=system. Three-layer redirect strategy:
  ...
  onMount(() => {
    void goto('/settings?tab=system', { replaceState: true });
  });
</script>

<svelte:head>
  <title>Settings · system · Cognis</title>
  <meta http-equiv="refresh" content="0; url=/settings?tab=system" />
</svelte:head>
