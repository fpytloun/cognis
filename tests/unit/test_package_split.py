    ...
    subprocess.run(
        [
            ...
            (
                ...
                "assert cognis.__version__ == '0.14.0'; "
...
@pytest.mark.parametrize(
    ...
    [
        (
            ("common",),
            (
                "import importlib.util, cognis; assert cognis.__version__ == '0.14.0'; "
    ...
    run(
        [
            ...
            (
                ...
                "import cognis.executor.runner; assert cognis.__version__ == '0.14.0'; "
