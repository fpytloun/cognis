...
_MODELS_TO_CHECK = (
    ...
    ("ExecutorTokenResponse", ExecutorTokenResponse),
    ("LLMProviderOAuthStatus", LLMProviderOAuthStatusResponse),
...
def test_ui_interface_covers_api_model_fields(interface_name: str, model_cls: type) -> None:
    ...
    allowed_missing = {
        ...
        "Deliverable": set(),
        "ExecutorConfig": set(),
        "ExecutorTokenResponse": set(),
        "LLMProviderOAuthStatus": set(),
        "MCPServerConfigResponse": set(),
        "MessageHistoryResponse": set(),
        "StepRun": set(),
        "PendingPause": set(),
        "Session": set(),
        "Skill": set(),
