...
def _test_config(tmp_path: Path, database_url: str) -> CognisConfig:
    ...
    return CognisConfig(
        ...
        shutdown_cancel_timeout_seconds=10,
        ...
        knowledgebase_qdrant_collection="cognis_knowledgebase_chunks",
        knowledgebase_index_poll_interval_seconds=5,
        knowledgebase_max_artifact_size_bytes=50 * 1024 * 1024,
        knowledgebase_max_chunks_per_artifact=2000,
        knowledgebase_chunk_target_tokens=800,
        knowledgebase_chunk_overlap_tokens=100,
        knowledgebase_embedding_batch_size=32,
