    ...
    async def search(
        ...
        *,
        ...
        try:
            ...
            requested_country_value = params.get("country")
            retry_country = (
                requested_country_value if isinstance(requested_country_value, str) else None
            )
            if (
                exc.response.status_code == 422
                and retry_country is not None
                and retry_country != "ALL"
