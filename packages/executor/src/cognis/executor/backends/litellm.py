...
from cognis.executor.backends.tts import run_synthesize_local
from cognis.executor.inference_types import (
    CognisInferenceRequest,
    image_generation_result_payload,
    json_safe_inference_payload,
)
from cognis.executor.providers.llm.performance import LocalGenerationPerformanceObserver
...
class LiteLLMExecutorBackend:
    ...
    async def stream_complete(
        ...
        try:
            if llm_api == "responses":
                ...
                async for chunk in responses_stream_to_chat_chunks(stream):
                    ...
                    terminal_details = response_incomplete_details(
                        payload.get("response_incomplete_details")
                    )
        ...
        yield cast(dict[str, Any], terminal)
    ...
    async def transcribe(
        ...
        *,
        ...
        from cognis.executor.audio_preprocessing import (
    ...
    async def synthesize(
        ...
        *,
        ...
        result = await run_synthesize_local(
            text=text,
            voice=voice,
            wire_model=wire_model,
