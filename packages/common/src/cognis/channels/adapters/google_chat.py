...
class GoogleChatAdapter(BaseChannelAdapter):
    ...
    async def _connect(self) -> None:
        ...
        self._app_credentials = service_account.Credentials.from_service_account_info(  # type: ignore[no-untyped-call]
        ...
        if delegated_user:
            self._setup_credentials = service_account.Credentials.from_service_account_info(  # type: ignore[no-untyped-call]
                self._service_account,
