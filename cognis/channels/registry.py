...
DISCORD_META = ChannelMeta(
    ...
    label="Discord",
    description="Discord Bot via Gateway WebSocket. Create a bot in the Discord Developer Portal.",
    icon="discord",
...
SLACK_META = ChannelMeta(
    channel_type="slack",
    label="Slack",
    description="Slack via Socket Mode (preferred) or HTTP Events API.",
    icon="slack",
