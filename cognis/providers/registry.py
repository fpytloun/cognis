...
if TYPE_CHECKING:
    ...
    from cognis.providers.executor.in_process import InProcessExecutorProvider  # noqa: F401
    from cognis.providers.executor.subprocess import SubprocessExecutorProvider  # noqa: F401
    from cognis.providers.executor.websocket import WebSocketExecutorProvider  # noqa: F401
...
def build_provider_registry(
    ...
    # Executor implementations are optional for controller-only imports and
    # are loaded only when the application builds its runtime registry.
    from cognis.providers.executor.composite import CompositeExecutorProvider
    from cognis.providers.executor.websocket import WebSocketExecutorProvider

    executor_available = is_executor_package_available()
